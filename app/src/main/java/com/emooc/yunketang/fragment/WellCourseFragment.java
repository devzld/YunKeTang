 ...
 */
public class WellCourseFragment extends Fragment {
...
//    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        refresh = (PullToRefreshListView) rootView.findViewById(R.id.refresh_lv);
        //    refresh = (WrapListView) findViewById(R.id.refresh_lv);

        refresh.setEnabled(false);


        adapter = new WellCourseAdapter(getActivity());
